...
class SegHandler(
    ...
    fun drawSolidWallRange(x1: Int, x2: Int) {
        ...
        val rwNormalAngle = seg.radAngle + PI.toFloat() / 2
    ...
    fun drawPortalWallRange(x1: Int, x2: Int) {
        ...
        if (worldFrontZ1 != worldBackZ1 ||
            ...
            bDrawUpperWall =
                side?.upperTextureName.toString().contentEquals("-") && worldBackZ1 < worldFrontZ1
        ...
        if (worldFrontZ2 != worldBackZ2 ||
            ...
            bDrawLowerWall =
                side?.lowerTextureName.toString().contentEquals("-") && worldBackZ2 > worldFrontZ2
        ...
        if (this.screenRange.isEmpty.not()) {
            ...
            if (intersection.isEmpty.not()) {
                if (intersection.cardinality() == (xEnd - xStart).absoluteValue) {
                    ...
                    drawSolidWallRange(xStart, xEnd - 1)
                } else {
